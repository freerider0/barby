  ...
  return (
    <>
        ...
        <section className='flex gap-6 w-full'>
          {/* Left Side */}
          <div className='flex w-64 flex-col gap-2 sm:w-56 lg:w-72 2xl:w-80'>
          ...
          {selectedUser ? (
            <div
              className={cn(
                ' left-full z-50 hidden w-full flex-1 flex-col rounded-md border bg-primary-foreground shadow-sm transition-all duration-200 sm:static sm:z-auto sm:flex',
            ...
            <div
              className={cn(
                ' inset-0 left-full z-50 hidden w-full flex-1 flex-col justify-center rounded-md border bg-primary-foreground shadow-sm transition-all duration-200 sm:static sm:z-auto sm:flex'
              )}
            >
